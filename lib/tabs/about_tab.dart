        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Android. Flutter. VolleyBall. Music.\nLikes Traveling.',
                ...
                children: <Widget>[
                  FlatButton.icon(
                    ...
                    onPressed: () => html.window
                        .open(Constants.PROFILE_GITHUB, 'BhatiPankaj'),
                  ),
                  ...
                  FlatButton.icon(
                    ...
                    label: Text('Medium'),
                    onPressed: () => html.window
                        .open(Constants.PROFILE_MEDIUM, '4121998bhati'),
                  )
                ],
              ),
              Row(
                ...
                children: <Widget>[
                  FlatButton.icon(
                    ...
                    label: Text('Linkedin'),
                    onPressed: () => html.window
                        .open(Constants.PROFILE_LINKEDIN, 'pankaj-bhati-90021a166'),
                  )
                ],
              )
            ],
